...
private  val TYPE_ITEM_ROOM=0
    private  val TYPE_ITEM_MESSAGE=1
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
           if(viewType==TYPE_ITEM_ROOM) {
               ...
               return RoomVievHolder(context,view)
           }
            val view=
                LayoutInflater.from(parent.context)
                    .inflate(R.layout.item_chat_message, parent, false)
            return MessageVievHolder(context,view)
    ...
    class   RoomVievHolder(context: Context, view:View) : RecyclerView.ViewHolder(view){
    ...
    class   MessageVievHolder(context: Context, view:View) :RecyclerView.ViewHolder(view){
